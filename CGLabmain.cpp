 ...
 * To compile using a command line using the GCC, type the command as below:
      g++ CGLabmain.cpp planetX.cpp -o planetX.exe -lopengl32 -lglu32 -lglut32
...
void myWelcome()
{
 ...
 cout << "*                     Trimester II, 2007/08                     *\n";
 cout << "*              Faculty of IT, Multimedia University             *\n";
 cout << "*    Copyright (C) 2007 by Ya-Ping Wong <ypwong@mmu.edu.my>     *\n";
 cout << "*****************************************************************\n";
 cout << "| Press:                                                        |\n";
